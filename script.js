...
const cases=[['Automotive Platform','A platform connecting vehicle owners with professional mechanics through messaging, video consultations and payments.','Bubble • Stripe • Agora • APIs'],['SaaS Marketplace','A multi-user marketplace with seller dashboards, payments, commissions and automated workflows.','Bubble • Stripe Connect • Automation'],['AI Contract Platform','An AI-powered platform for contract analysis, reporting and estimation.','Bubble • OpenAI • Stripe'],['Workforce Management','A role-based platform for managing organisations, locations, staff and workflows.','Bubble • APIs • Automation']];
